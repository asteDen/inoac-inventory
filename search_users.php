      ...
      <div id="wrapper">
        ...
        <form method="GET" action="<?php echo $_SERVER['PHP_SELF'] ?>">
          <div class="input-group mb-3">
            <?php $searchUser = $_GET['searchUser']; ?>
            <input type="text" class="form-control" placeholder="Search" name="searchUser" value="<?php echo $searchUser ?>">
      ...
      <div class="table-responsive-lg">         
        <table class="table table-bordered table-hover">
          ...
          <?php 
            ...
            $querySearch = "SELECT * FROM users WHERE id LIKE '$searchUser%' OR firstname LIKE '$searchUser%' OR lastname LIKE '$searchUser%' OR gender LIKE '$searchUser%' OR department LIKE '$searchUser%' OR computer_id LIKE '$searchUser%' OR laptop_id LIKE '$searchUser%'";
            $sqlSearch = mysqli_query($connection, $querySearch);
          
          
          while($results = mysqli_fetch_array($sqlSearch)) {?>
