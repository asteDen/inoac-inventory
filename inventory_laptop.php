...
<body>
      ...
      <div id="wrapper">
        ...
        <form method="GET" action="./search_laptop.php">
          <div class="input-group">
            <input type="text" class="form-control" placeholder="Search" name="searchLaptop">
          <div class="input-group-append">
            ...
            <table class="table table-bordered table-hover">
                ...
                <?php while($results = mysqli_fetch_array($sqlLaptop)) {?>
                <tbody>
                  <tr>
