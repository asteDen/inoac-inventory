...
<head>
    ...
    <title>INOAC | ADD COMPUTER</title>
</head>
<body>
        ...
        <form action="./add_computer.php" method="post">
                <div class="form-row">
                    <div class="form-group col-lg-2 pt-3">
                        ...
                        <input type="text" class="form-control" id="" placeholder="" name="computerId" value="" required>
                    </div>

                    <div class="form-group col-lg-2 pt-3">
                        <label for="">Os version: </label>
                        <select id="" class="form-control" name="osVersion">
                    ...
                    <div class="form-group col-lg-2 pt-3">
                        ...
                        <select id="" class="form-control" name="processor">
                    ...
                    <div class="form-group col-lg-2 pt-3">
                        ...
                        <input type="date" class="form-control" id="" placeholder="" name="dateAquiredComputer" value="<?php echo $updateFirstname ?>" required>
                    </div>
                    <div class="form-group col-lg-2 pt-3">
                        <label for="">Ip address:</label>
                        <input type="text" class="form-control" id="" placeholder="" name="ipAddress" value="" required>
                    </div>
                </div>
                ...
                <div class="container mt-3 p-3 mb-2 bg-light text-dark" style="padding-top:20px;">
                    ...
                    <button type="submit" class="btn btn-primary" name="addComputer">Add</button>
                </div>
            </form>
        </div>
