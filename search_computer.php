      ...
      <div id="wrapper">
        ...
        <form method="GET" action="<?php echo $_SERVER['PHP_SELF'] ?>">
          <div class="input-group">
            <?php $searchComputer = $_GET['searchComputer']; ?>
            <input type="text" class="form-control" placeholder="Search" name="searchComputer" value="<?php echo $searchComputer ?>">
          <div class="input-group-append">
            ...
            <table class="table table-bordered table-hover">
                ...
                $querySearchComputer = "SELECT computers.computer_id, users.department, users.firstname, users.lastname, computers.os_version, computers.processor, computers.date_aquired, computers.ip_address
                                        FROM users
                                        RIGHT JOIN computers ON users.computer_id = computers.computer_id 
                                        where computers.computer_id like '$searchComputer%' OR users.department like '$searchComputer%' OR users.firstname like '$searchComputer%' OR users.lastname like '$searchComputer%' OR computers.os_version like '$searchComputer%' OR computers.processor like '$searchComputer%' OR computers.date_aquired like '$searchComputer%' OR computers.ip_address like '$searchComputer%'";

                $sqlSSearchComputer = mysqli_query($connection, $querySearchComputer);
                    
                
                
                
                while($results = mysqli_fetch_array($sqlSSearchComputer)) {?>
                <tbody>
                  <tr>
